...
def warehouse_performance(data):
    ...
    st.markdown(
        """
        <div class="insight-card">
            <b>Interpretation:</b> Warehouses in the upper-right zone of the bubble chart
            have both higher utilization and higher high-risk order counts. These should be
            reviewed first for routing optimization, capacity balancing, and overflow planning.
        </div>
        """,
        unsafe_allow_html=True,
    )
